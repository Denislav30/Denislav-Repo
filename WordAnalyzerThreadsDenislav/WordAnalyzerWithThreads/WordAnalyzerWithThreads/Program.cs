...
namespace ArrayExercise
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Thread calculateWordsThread = new Thread(delegate ()
            {
            ...
            {
                Console.WriteLine("Средна дължина на думите: " + averageWordLength(words));
                Console.WriteLine();
            });
            

            Thread fiveMostCommonWordsThread = new Thread(delegate ()
            {
            ...
            Thread fiveLeastCommonWordsThread = new Thread(delegate ()
            {
                string[] fiveLeastCommonWords = FiveLeastCommonWords(words);
                Console.WriteLine("Петте най - рядко срещани думи са: ");
            ...
            calculateWordsThread.Start();
            shortestWordThread.Start();
            longestWordThread.Start();
            averageWordLengthThread.Start();
            fiveMostCommonWordsThread.Start();
            fiveLeastCommonWordsThread.Start();
